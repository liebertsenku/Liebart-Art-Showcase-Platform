        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden sm:flex sm:items-center space-x-6">
                    <a href="{{ route('home') }}" class="text-sm font-medium text-gray-500 hover:text-black transition {{ request()->routeIs('home') ? 'text-black' : '' }}">
                        Explore
                    </a>
                    <a href="{{ route('home', ['sort' => 'popular']) }}" class="text-sm font-medium text-gray-500 hover:text-black transition">
                        Popular
                    </a>
                </div>
            </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false" class="flex items-center gap-3 focus:outline-none group">
                            <div class="text-right hidden md:block">
                                ...
                                <div class="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">{{ Auth::user()->role ?? 'Member' }}</div>
                            </div>
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-black">
        ...
        <div class="pt-4 pb-4 border-t border-gray-200 px-4">
            @auth
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('profile.edit') }}" class="block w-full text-left py-2 text-sm text-gray-600">Settings</a>
